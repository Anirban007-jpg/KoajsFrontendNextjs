...
const Details = ({ position, company, time, companyLink, address, work }) => {
    ...
    return (
        <li ref={ref} className='my-8 mt-16 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between'>
    ...
    return (
        <>
            <Layout className='!mt-[-80px]'>
                ...
                <div className='my-64'>
                    <h2 className='font-bold text-6xl mt-[-20px] mb-2 w-full text-center'>How This Website Works!</h2>
                    <div ref={ref} className='w-[75%] mx-auto relative'>
                        <motion.div style={{ scaleY: scrollYProgress }} className='absolute left-9 top-22 w-[4px] h-full bg-black origin-top' />
